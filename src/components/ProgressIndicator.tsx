...
const STEPS: { key: PipelineStep; label: string; description: string }[] = [
  { key: 'sourcing', label: '수집', description: '실시간 트렌드 분석 및 뉴스 수집 중...' },
  { key: 'analyzing', label: '분석', description: '핵심 메시지와 타겟 오디언스 파악 중...' },
  { key: 'structuring', label: '구조', description: 'AIDA 프레임워크로 슬라이드 구조 설계 중...' },
  { key: 'writing', label: '작성', description: 'Opus AI가 각 슬라이드의 카피를 작성 중...' },
  { key: 'querying', label: '기획', description: '슬라이드에 맞는 비주얼 키워드 생성 중...' },
  { key: 'searching', label: '검색', description: 'Unsplash + Pexels에서 최적 이미지 수집 중...' },
        ...
        <CardContent className="p-0 space-y-6">
          ...
          <div className="pt-2 border-t">
            <div className="flex items-start gap-2 min-h-[2.5rem]">
              <span className="text-xs text-muted-foreground/60 font-medium shrink-0 mt-0.5">TIP</span>
              <p
                key={tipIdx}
